...
// 2. Memanggil file koneksi dan arsitektur OOP Pendaftaran
require_once 'koneksi.php';
require_once 'pendaftaran.php';

// Memanggil 3 file subclass spesifik jalur
require_once 'PendaftaranReguler.php';
require_once 'PendaftaranPrestasi.php';
require_once 'PendaftaranKedinasan.php';

// 3. Instansiasi koneksi database
$database = new Koneksi();
// Membuka akses properti koneksi internal (mengambil properti protected $conn dari class Koneksi)
// Jika di class Koneksi kamu propertinya protected, pastikan ada method getter, atau ganti visibilitasnya di bawah ini:
$dbConnection = (fn() => $this->conn)->call($database); 

// 4. Manfaatkan Metode Query Spesifik dari Tahap 4 untuk mengambil data terkelompok
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        /* --- SECTION MANAGEMENT --- */
        .section-title { font-size: 20px; font-weight: bold; margin: 35px 0 15px 0; padding-bottom: 8px; border-bottom: 2px solid #e2e8f0; display: flex; align-items: center; gap: 10px; }
        ...
        .card-pendaftar { background-color: #fff; padding: 22px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.02); border-top: 5px solid #3b82f6; display: flex; flex-direction: column; justify-content: space-between; transition: transform 0.2s; }
        ...
        .spesifik-box { background-color: #f8fafc; padding: 12px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 13.5px; color: #475569; margin-bottom: 15px; line-height: 1.6; }
        .harga-total { font-size: 16px; font-weight: bold; color: #0f172a; padding-top: 12px; border-top: 1px dashed #e2e8f0; display: flex; justify-content: space-between; align-items: center; }
        .harga-total span { color: #ef4444; font-size: 17px; }
    </style>
</head>
<body>
    ...
    <main class="main-content">
        ...
        <div class="content-body">
            ...
            <div class="section-title title-prestasi">🔵 Jalur Prestasi (Insentif Potongan Rp50.000)</div>
            <div class="grid-pendaftaran">
            ...
            <div class="section-title title-kedinasan">🟣 Jalur Kedinasan (Surcharge Sektor Mitra 25%)</div>
            <div class="grid-pendaftaran">
